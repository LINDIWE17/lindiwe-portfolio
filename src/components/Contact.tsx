            ...
            <div className="bg-dark-200 rounded-lg p-8">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="https://github.com/LINDIWE17/LINDIWE17" className="text-2xl text-gray-400 hover:text-highlight transition-colors" target="_blank" rel="noopener noreferrer">
                    <span title="GitHub">
